...
class OutputFile:
    ...
    def add_meta_vocab(self, vocab: Vocab, params: Params) -> None:
        tokens = []
        scores = []
        toktypes = []
        ...
        if params.n_vocab > len(tokens):
            n_model_tokens = len(tokens)
            for i in range(params.n_vocab - n_model_tokens):
                token_id = i + n_model_tokens
    ...
    def write_vocab_only(fname_out: Path, params: Params, vocab: Vocab, svocab: gguf.SpecialVocab, endianess:gguf.GGUFEndian=gguf.GGUFEndian.LITTLE) -> None:
        ...
        of.add_meta_vocab(vocab, params)
